                        ...
                        try {
                            ...
                            if (pinData && !executionNode.disabled && pinData[executionNode.name] !== undefined) {
                                ...
                                if (nodeSuccessData && executionData.node.onError === 'continueErrorOutput') {
                                    ...
                                    const errorItems = [];
                                    const successItems = [];
                                    const executeFunctions = NodeExecuteFunctions.getExecuteFunctions(workflow, this.runExecutionData, runIndex, [], executionData.data, executionData.node, this.additionalData, executionData, this.mode);
