                ...
                async create() {
                    ...
                    try {
                        ...
                        if (error.cause.httpCode === '422') {
                            ...
                            throw new n8n_workflow_1.NodeOperationError(this.getNode(), 'A webhook with the identical URL probably exists already. Please delete it manually on Github!', { severity: 'warning' });
                        }
                        if (error.cause.httpCode === '404') {
                            throw new n8n_workflow_1.NodeOperationError(this.getNode(), 'Check that the repository exists and that you have permission to create the webhooks this node requires', { severity: 'warning' });
                        }
                        throw error;
                    }
