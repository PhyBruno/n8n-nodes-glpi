    ...
    async execute() {
        ...
        for (let itemIndex = 0; itemIndex < items.length; itemIndex++) {
            ...
            if (pagination && pagination.paginationMode !== 'off') {
                ...
                const requestPromise = this.helpers.requestWithAuthenticationPaginated.call(this, requestOptions, itemIndex, paginationData, nodeCredentialType !== null && nodeCredentialType !== void 0 ? nodeCredentialType : genericCredentialType);
        ...
        for (let itemIndex = 0; itemIndex < items.length; itemIndex++) {
            ...
            if (responseData.status !== 'fulfilled') {
                ...
                if (!this.continueOnFail()) {
                    ...
                    throw new n8n_workflow_1.NodeApiError(this.getNode(), responseData, { itemIndex });
                }
                else {
