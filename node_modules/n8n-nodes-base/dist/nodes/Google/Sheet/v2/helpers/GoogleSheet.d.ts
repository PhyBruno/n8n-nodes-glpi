import type { IExecuteFunctions, ILoadOptionsFunctions, IDataObject, IPollFunctions, INode } from 'n8n-workflow';
...
export declare class GoogleSheet {
    ...
    spreadsheetGetSheetNameById(node: INode, sheetId: string): Promise<any>;
