...
function getSpreadsheetId(node, documentIdType, value) {
    if (!value) {
        throw new n8n_workflow_1.NodeOperationError(node, `Can not get sheet '${GoogleSheets_types_1.ResourceLocatorUiNames[documentIdType]}' with a value of '${value}'`, { severity: 'warning' });
    }
